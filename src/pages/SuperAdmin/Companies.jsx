  ...
  return (
    <Box sx={{ p: 3 }}>
              ...
              <TableBody>
                {companies.map((company) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {(() => {
                        const companyPlanName = company.plan_name || plans.find((p) => p.id == company.plan_id)?.name;
                        return companyPlanName ? (
                          <Chip
                            label={companyPlanName}
                            size="small"
                            color="secondary"
      ...
      <Dialog open={openPasswordDialog} onClose={() => setOpenPasswordDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle>
          <Typography variant="h6" component="div" fontWeight={600}>Reset Company Admin Password</Typography>
          <Typography variant="caption" color="text.secondary">
      ...
      <Dialog open={openSubscriptionDialog} onClose={() => setOpenSubscriptionDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle>
          <Typography variant="h6" component="div" fontWeight={600}>Subscription Details</Typography>
        </DialogTitle>
        <DialogContent>
          {selectedCompany && (
            <Box sx={{ pt: 2 }}>
      ...
      <Dialog open={openNotificationDialog} onClose={() => setOpenNotificationDialog(false)} maxWidth="sm" fullWidth>
        <DialogTitle>
          <Typography variant="h6" component="div" fontWeight={600}>Send Notification</Typography>
          <Typography variant="caption" color="text.secondary">
