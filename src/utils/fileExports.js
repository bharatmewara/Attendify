...
export const buildDocumentHtml = ({ title, employeeName, companyName, content, accentColor = '#1d4ed8' }) => `<!doctype html>
<html>
  <head>
    <meta charset="utf-8" />
    <title>${title}</title>
  ...
  <body>
    <div class="frame">
      <div class="head">
        <h1>${title}</h1>
        <div class="meta">${companyName || 'Attendify'} | ${employeeName || ''}</div>
      </div>
